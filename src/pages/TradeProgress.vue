  ...
  <div class="trade-progress">
    <div class="top">
      <tabnav class="tab" justify="justify">
        <router-link tag="div" to="/tradeprogress/contract" class="tabnav-item">合同进度</router-link>
        <router-link tag="div" to="/tradeprogress/lincense" class="tabnav-item">产证进度</router-link>
      </tabnav>
    </div>
